...
const en = {
  ...
  dashboardScreen: {
    ...
    greetingMorningWithName: "Good morning, {{firstName}}",
    greetingAfternoon: "Good afternoon",
    greetingAfternoonWithName: "Good afternoon, {{firstName}}",
    greetingEvening: "Good evening",
    greetingEveningWithName: "Good evening, {{firstName}}",
  ...
  skuListScreen: {
    ...
    noSearchResults: "No SKUs match your search",
    ...
    timeoutError: "The request took too long. Check your connection and tap Retry.",
    retry: "Retry",
    stockTakeButton: "Stock take",
  },
  addSkuScreen: {
    ...
    uomPickerPlaceholder: "Select unit",
    uomModalTitle: "Unit of measure",
    uomOptionOther: "Other",
    uomOtherLabel: "Custom unit",
    uomOtherPlaceholder: "e.g. pallet",
    uomPlaceholder: "e.g. pcs, box, kg",
    safetyStockLabel: "Safety Stock Threshold",
    safetyStockPlaceholder: "0",
    photoLabel: "Product photo",
    photoActionTitle: "Product image",
    photoPlaceholder: "Tap to add a photo (optional)",
    photoTakePhoto: "Take Photo",
    photoChooseLibrary: "Choose from Library",
    photoPermissionCamera: "Camera access is needed to take a photo.",
    photoPermissionLibrary: "Photo library access is needed to choose an image.",
    photoPermissionHint: "You can enable access in Settings.",
    ...
    validationSkuCodeDuplicate: "This SKU code already exists.",
    ...
    validationUomRequired: "Select a unit of measure.",
    validationUomInvalid: "Select a valid unit of measure.",
    validationUomOtherRequired: "Enter a custom unit.",
  ...
  skuDetailScreen: {
    ...
    deleteSkuButton: "Delete SKU",
    deleteSkuAlertTitle: "Delete {{name}}?",
    deleteSkuAlertUnnamedName: "this item",
    deleteSkuAlertMessage:
      "This will permanently delete this item and all its transaction history. This cannot be undone.",
    deleteSkuConfirm: "Delete",
    deleteSkuSuccessTitle: "SKU deleted",
    deleteSkuError: "Could not delete this SKU. Try again.",
    valueEmpty: "—",
    timelinePillPurchase: "Stock Received",
    timelinePillSale: "Sale",
    timelinePillStockTake: "Stock take",
    timelinePillScrap: "Scrap",
    timelinePillOther: "Adjustment",
    ...
    historyHeaderType: "TYPE",
    historyHeaderQty: "QTY",
    historyHeaderDate: "DATE",
    historyHeaderNote: "NOTE",
  ...
  stockTakeScreen: {
    title: "Stock take",
    subtitle: "Enter counts below. System quantity and variance are shown after you submit.",
    tabAllSkus: "All SKUs",
    tabSelectSkus: "Select SKUs",
    searchLabel: "Find SKU",
    searchPlaceholder: "Search by name or code",
    searchHint: "Type a product name or SKU code, then tap a row to add it to this count.",
    noSearchResults: "No matching SKUs.",
    addSkuAction: "Add",
    removeFromCount: "Remove",
    selectModeEmpty: "No SKUs added yet. Use the search above to add SKUs to count.",
    includeSkuA11y: "Include SKU in count",
    systemQtyLabel: "System qty",
    countedLabel: "Counted qty",
    countedPlaceholder: "0",
    varianceLabel: "Variance",
    lastCountedLabel: "Last counted",
    lastCountedNever: "Never",
    confirmButton: "Submit count",
    doneButton: "Done",
    retry: "Retry",
    ...
    adjustmentReferenceNote: "Stock take adjustment",
    ...
    validationNoSkusSelected: "Select at least one SKU to include in this stock take.",
    reviewSubtitle: "Review your counts and variance before continuing.",
    recountButton: "Recount",
    cancelCountButton: "Cancel Count",
    acceptCountButton: "Accept Count",
  ...
  inventoryAdjustmentScreen: {
    ...
    insufficientStockReduceError: "Not enough stock — you only have {{count}} units available.",
  ...
  paywallScreen: {
    ...
    featureFullTransactionHistory: "Full transaction history",
  ...
  profileScreen: {
    ...
    proBadge: "PRO",
    trialDayRemaining: "Free Trial — {{count}} day remaining",
    trialDaysRemaining: "Free Trial — {{count}} days remaining",
    subscribe: "Subscribe",
    // Settings section
    ...
    biometricPasswordSubtitle:
      "Enter your account password once to enable biometric sign-in on the login screen.",
    darkMode: "Dark Mode",
